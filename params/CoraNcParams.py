...
def add_params(parser):
    ...
    ##model_config
    parser.add_argument('--model', type=str, default='Shallow', choices=['Shallow', 'MLP', 'HNN', 'GCN', 'GAT', 'HGCN'])
    parser.add_argument('--dim', type=int, default=16)  
    parser.add_argument('--manifold', type=str, default='Euclidean', choices=['Euclidean', 'Hyperboloid', 'PoincareBall'])
    parser.add_argument('--c', default=1.0)
    parser.add_argument('--r', default=2.)
    parser.add_argument('--t', default=1.)
    parser.add_argument('--pretrained-embeddings', default="lp/2022_1_19/8")
