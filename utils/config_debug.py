...
from train_utils import add_flags_from_config
...
config_args = {
    'training_config': {
        ...
        'save-dir': ('logs/results', 'path to save training logs and model weights (defaults to logs/task/date/run/)'),
        'sweep-c': (0, ''),
    ...
    'data_config': {
        'dataset': ('MEG', 'which dataset to use'),
